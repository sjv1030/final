...
df_fund_facts = pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_price_perf =  pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_current_prices = pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_hist_prices = pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_avg_returns = pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_after_tax =  pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
df_recent_returns =  pd.DataFrame({"a": [1, 2, 3, 4], "b": [2, 3, 4, 5]})
...
def get_menu():
    menu = html.Div([
        ...
        dcc.Link('Price Performance   ', href='/apps/app_oil/price-performance', className="tab"),
        dcc.Link('Portfolio & Management   ', href='/apps/app_oil/portfolio-management', className="tab"),
        dcc.Link('Fees & Minimums   ', href='/apps/app_oil/fees', className="tab"),
        dcc.Link('Distributions   ', href='/apps/app_oil/distributions', className="tab"),
        dcc.Link('News & Reviews   ', href='/apps/app_oil/news-and-reviews', className="tab")
    ], className="row ")
    return menu
            ...
            html.Div([
                html.Div([
                    ...
                    html.P("\
                            ...
                            Therefore most traders tend to analyze only onw or two futures at a \
